...
@else
    ...
    >
        ...
        <div x-show="showModuleModal" x-cloak class="position-fixed top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center p-16" style="z-index:1050;">
        ...
        <div x-show="showLessonModal" x-cloak class="position-fixed top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center p-16" style="z-index:1050;">
